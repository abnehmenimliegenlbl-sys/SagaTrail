  ...
  export const CURATED_SAGAS: InsertCatalogSaga[] = [
{
  ...
  "summaries": {
    "gsw": {
      "title": "Wilhälm Täll – Apfälschuss u Tällsprung",
    ...
    "fr": {
      "title": "Guillaume Tell – Le Coup de la Pomme et le Saut de Tell",
    ...
    "it": {
      "title": "Guglielmo Tell – Il Colpo della Mela e il Salto di Tell",
    ...
    "en": {
      "title": "William Tell – The Apple Shot and Tell's Leap",
    ...
    "pt": {
      "title": "Guilherme Tell – O Tiro da Maçã e o Salto de Tell",
    ...
    "ru": {
      "title": "Вильгельм Телль – выстрел в яблоко и прыжок Телля",
      "text": "Ландфогт Гессер принудил Вильгельма Телля выстрелить из арбалета в яблоко на голове собственного сына. Телль поразил цель, но так как он приготовил второй болт для фогта, его схватили и повезли через Урнерское озеро. Когда разыгралась буря, ему дали вёсла; у скалы Телльсплатте он прыгнул на камни и отправил лодку назад в бушующие волны.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Gallus u der Bär a de Stäibach",
    ...
    "fr": {
      "title": "Gallus et l'Ours à la Steinach",
    ...
    "it": {
      "title": "Gallus e l'Orso alla Steinach",
    ...
    "en": {
      "title": "Gallus and the Bear at the Steinach",
    ...
    "es": {
      "title": "Galo y el Oso en la Steinach",
    ...
    "pt": {
      "title": "Galo e o Urso no Steinach",
    ...
    "ru": {
      "title": "Святой Галл и медведь на реке Штайнах",
      "text": "Ирландский монах Галл следовал по течению Штайнаха в дикую местность и упал в терновник – знак остаться здесь. Ночью из леса вышел медведь; Галл велел ему подбрасывать дрова в огонь и дал ему за это хлеб. Медведь повиновался и удалился в горы; на этом месте впоследствии вырос монастырь Санкт-Галлена.",
      "reviewEmpfohlen": true
    },
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Der Tüüfelskäller bim Bade",
    ...
    "fr": {
      "title": "La Cave du Diable près de Baden",
    ...
    "it": {
      "title": "La Cantina del Diavolo presso Baden",
    ...
    "en": {
      "title": "The Devil's Cellar near Baden",
    ...
    "es": {
      "title": "La Cueva del Diablo cerca de Baden",
    ...
    "pt": {
      "title": "A Adega do Diabo perto de Baden",
    ...
    "ru": {
      "title": "Дьявольский погреб близ Бадена",
      "text": "Близ Бадена громадные скальные глыбы беспорядочно нагромождены друг на друга – это Дьявольский погреб. По преданию, дьявол принёс эти огромные камни, чтобы завалить ими церковь и город. Но прежде чем ему удалось завершить своё чёрное дело, его застали рассвет и звон колоколов, так что он бросил камни там, где они лежат и по сей день.",
      "reviewEmpfohlen": true
    },
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D'Quille du Diable u de Bergstürz vu de Diablärä",
    ...
    "fr": {
      "title": "La Quille du Diable et l'Éboulement des Diablerets",
    ...
    "it": {
      "title": "Il Birillo del Diavolo e la Frana dei Diablerets",
    ...
    "en": {
      "title": "The Devil's Bowling Pin and the Diablerets Landslide",
    ...
    "pt": {
      "title": "O Pino do Diabo e o Deslizamento dos Diablerets",
    ...
    "ru": {
      "title": "Булава дьявола и обвал гор Дьябле",
      "text": "На высокогорных пастбищах Дьябле по ночам, говорят, дьяволы играли в кегли, катая громадные скальные глыбы – отсюда булава дьявола, её название. Их дикая игра и святотатство людей привели гору в движение: мощные обвалы похоронили некогда зелёные альпы под обломками, и с тех пор это горное массив носит имя дьявола.",
      "reviewEmpfohlen": true
    },
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "S'Wilde Heer über em Sändis",
    ...
    "fr": {
      "title": "L'Armée Sauvage au-dessus du Säntis",
    ...
    "it": {
      "title": "L'Esercito Selvaggio sopra il Säntis",
    ...
    "en": {
      "title": "The Wild Hunt above the Säntis",
    ...
    "es": {
      "title": "La Caza Salvaje sobre el Säntis",
    ...
    "pt": {
      "title": "A Caçada Selvagem acima do Säntis",
    ...
    "ru": {
      "title": "Дикая охота над Зентисом",
      "text": "В бурные ночи, рассказывают в земле Аппенцелль, Дикая охота с лаем собак и звуками рогов проносится над гребнями Альпштайна. Тот, кто встретит этот призрачный поезд на улице, должен упасть лицом на землю и оставаться неподвижным, пока привидение не пройдёт мимо — кто посмотрит на него или крикнет вслед, будет унесён и найден лишь далеко отсюда, потрясённый и без воспоминаний.",
      "reviewEmpfohlen": true
    },
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "S'Sännä-Tuntschi im Alpstäi",
    ...
    "fr": {
      "title": "Le Sennentuntschi dans l'Alpstein",
    ...
    "it": {
      "title": "Il Sennentuntschi nell'Alpstein",
    ...
    "en": {
      "title": "The Sennentuntschi in the Alpstein",
    ...
    "es": {
      "title": "El Sennentuntschi en el Alpstein",
    ...
    "pt": {
      "title": "O Sennentuntschi no Alpstein",
    ...
    "ru": {
      "title": "Сеннентунчи в Альпштайне",
      "text": "На одной одинокой альпийской хижине в Альпштайне пастухи якобы создали из соломы, тряпья и коровьего молока куклу, чтобы позабавиться во время одинокого летнего сезона — Сеннентунчи. В ночь, как говорят, кукла ожила и страшно отомстила за насмешку, с которой её создали, прежде чем с первым звоном долинного колокола бесследно исчезла.",
      "reviewEmpfohlen": true
    },
  },
...
},
{
  ...
  "summaries": {
    ...
    "fr": {
      "title": "Le Petit Homme de la Pluie de Zunzgen",
    ...
    "it": {
      "title": "L'Ometto della Pioggia di Zunzgen",
    ...
    "en": {
      "title": "The Rain Manikin of Zunzgen",
    ...
    "es": {
      "title": "El Hombrecillo de la Lluvia de Zunzgen",
    ...
    "pt": {
      "title": "O Homenzinho da Chuva de Zunzgen",
    ...
    "ru": {
      "title": "Грифон Фогель-Гриф из Малого Базеля",
      "text": "Малый Базель, расположенный на правом берегу Рейна, издавна носит грифона в своём гербе и чествует его как Фогель-Гриф собственным праздничным днём. По легенде, именно гордый грифон защищал малобазельскую сторону Рейна против большебазельской стороны, когда оба берега ещё были отдельными городами — до сих пор Фогель-Гриф при своём появлении бросает взгляд через Рейн, но никогда не переходит его.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "fr": {
      "title": "L'Oiseau Gryff de Kleinbâle",
    ...
    "it": {
      "title": "L'Uccello Gryff di Kleinbasel",
    ...
    "en": {
      "title": "The Bird Gryff of Kleinbasel",
    ...
    "es": {
      "title": "El Pájaro Gryff de Kleinbasel",
    ...
    "pt": {
      "title": "O Pássaro Gryff de Kleinbasel",
    ...
    "ru": {
      "title": "Медвежья легенда Берна",
      "text": "Когда герцог Бертольд V фон Царинген в 1191 году основал новый город на Аре, повествует древняя бернская хроника, он хотел назвать его в честь первого животного, которое будет добыто на охоте в окружающем лесу. Это был медведь — и так город получил своё имя Берн и своё гербовое животное, которое можно встретить до сих пор в Медвежьей яме близ Старого города.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "fr": {
      "title": "La Légende de l'Ours de Berne",
    ...
    "it": {
      "title": "La Leggenda dell'Orso di Berna",
    ...
    "es": {
      "title": "La Leyenda del Oso de Berna",
    ...
    "pt": {
      "title": "A Lenda do Urso de Berna",
    ...
    "ru": {
      "title": "Легенда о Чёрном озере",
      "text": "Там, где сегодня расположено Чёрное озеро в округе Зензе, рассказывают во Фрибурге, когда-то стояло село, жители которого в благополучии и гордыне забыли гостеприимство и благочестие. В наказание село за одну ночь погрузилось в воды, и с тех пор в тихие ночи говорят, что из глубины тёмного озера доносится звон колоколов.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "it": {
      "title": "La Leggenda del Lago Nero",
    ...
    "en": {
      "title": "The Legend of the Black Lake",
    ...
    "es": {
      "title": "La Leyenda del Lago Negro",
    ...
    "ru": {
      "title": "Котёл матери Руаяма",
      "text": "В ночь с 11 на 12 декабря 1602 года савойские войска с помощью лестниц пытались взобраться на стены Женевы и захватить город. По преданию, бдительная хозяйка, мать Руаяма, вылила кипящий овощной суп из своего котла на нападающих и даже сбила с ног одного солдата – её боевой клич пробудил город, который отразил приступ.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D'Marmitä vu de Mère Royaume",
    ...
    "fr": {
      "title": "La Marmite de la Mère Royaume",
    ...
    "it": {
      "title": "La Pentola della Madre Royaume",
    ...
    "en": {
      "title": "The Pot of Mother Royaume",
    ...
    "es": {
      "title": "La Olla de la Madre Royaume",
    ...
    "pt": {
      "title": "O Caldeirão da Mãe Royaume",
    ...
    "ru": {
      "title": "Святой Фридолин и мёртвый брат",
      "text": "По древнему преданию, святой Фридолин получил землю в дар для монастыря, однако после смерти дарителя его брат оспорил подарок в суде. Тогда Фридолин велел поднять мёртвого из могилы: труп восстал и свидетельствовал о пожертвовании перед всеми присутствующими, а затем снова лёг в земле – по сей день на гларнском гербе изображён Фридолин со скелетом у его боку.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Der heilig Fridolin u der tot Brueder",
    ...
    "fr": {
      "title": "Saint Fridolin et le Frère Mort",
    ...
    "it": {
      "title": "San Fridolino e il Fratello Morto",
    ...
    "en": {
      "title": "Saint Fridolin and the Dead Brother",
    ...
    "es": {
      "title": "San Fridolín y el Hermano Muerto",
    ...
    "pt": {
      "title": "Santo Fridolino e o Irmão Morto",
    ...
    "ru": {
      "title": "Легенда об оползне у Флимса",
      "text": "В незапамятные времена, рассказывают в Сурсельве, разгневанные гиганты срывали целые склоны гор над Флимсом и швыряли их в долину. Мощный поток обломков погребал под собой леса и долины, формируя суровый каньон Переднего Рейна, по которому река прокладывает себе путь до наших дней.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D'Saga vom Flimser Bergstürz",
    ...
    "fr": {
      "title": "La Légende de l'Éboulement de Flims",
    ...
    "it": {
      "title": "La Leggenda della Frana di Flims",
    ...
    "en": {
      "title": "The Legend of the Flims Landslide",
    ...
    "es": {
      "title": "La Leyenda del Derrumbe de Flims",
    ...
    "pt": {
      "title": "A Lenda do Deslizamento de Flims",
    ...
    "ru": {
      "title": "Золотая скала у Реклер",
      "text": "В лесах у Реклер в Юре лежит Рош д'Ор, Золотая скала, под которой по преданию спрятан клад. Чтобы поднять его, нужно действовать молча и без алчности – но того, кого манила жажда золота, ждало проклятие: вход в скалу для него навеки закрывался.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D'Roche d'Or bim Réclère",
    ...
    "fr": {
      "title": "Le Rocher d'Or à Réclère",
    ...
    "it": {
      "title": "La Roccia d'Oro a Réclère",
    ...
    "en": {
      "title": "The Golden Rock at Réclère",
    ...
    "es": {
      "title": "La Roca Dorada en Réclère",
    ...
    "pt": {
      "title": "A Rocha Dourada em Réclère",
    ...
    "ru": {
      "title": "Огнедышащий дракон горы Пилатус",
      "text": "Уже в XVI веке натуралист Конрад Геснер сообщал о появлениях огнедышащего дракона на горе Пилатус близ Люцерна. Согласно легенде, драконы обитают в глубоких пещерах внутри горы и летают над её гребнями во время штормов; одному пастуху дракон якобы спас жизнь, вытащив его из расселины скалы, в которую он упал.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "en": {
      "title": "The Dragon of Mount Pilatus",
    ...
    "ru": {
      "title": "Вуивр на Невшательском озере",
      "text": "В лесах вокруг Невшательского озера, как говорится в предании, бродит Вуивр — крылатая змея, носящая вместо глаза сияющий драгоценный камень. Перед купанием она откладывает камень на берег — тот, кто смог бы его украсть, разбогатеет, но Вуивр замечает любое приближение и беспощадно преследует каждого вора.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D'Vouivre am Nüiburgersee",
    ...
    "fr": {
      "title": "La Vouivre au Lac de Neuchâtel",
    ...
    "it": {
      "title": "La Vouivre al Lago di Neuchâtel",
    ...
    "en": {
      "title": "The Vouivre at Lake Neuchâtel",
    ...
    "es": {
      "title": "La Vouivre en el Lago de Neuchâtel",
    ...
    "pt": {
      "title": "A Vouivre no Lago de Neuchâtel",
    ...
    "ru": {
      "title": "Арнольд фон Винкельрид при Земпахе",
      "text": "В битве при Земпахе 1386 года, как повествует старая хроника, конное войско габсбургских рыцарей стояло со своими копьями как непреодолимая стена. Тогда Арнольд фон Винкельрид из Станса якобы воскликнул, чтобы позаботились о его жене и детях, и с распростёртыми объятиями бросился на острия копий, чтобы пробить проход для своих товарищей в ряды врага.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Arnold vu Winkälried bim Sempach",
    ...
    "fr": {
      "title": "Arnold de Winkelried à Sempach",
    ...
    "it": {
      "title": "Arnold di Winkelried a Sempach",
    ...
    "en": {
      "title": "Arnold von Winkelried at Sempach",
    ...
    "pt": {
      "title": "Arnold von Winkelried em Sempach",
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Brueder Chlaus u d'Visioon im Ranft",
    ...
    "fr": {
      "title": "Frère Klaus et la Vision au Ranft",
    ...
    "it": {
      "title": "Fratello Klaus e la Visione nel Ranft",
    ...
    "en": {
      "title": "Brother Klaus and the Vision at Ranft",
    ...
    "es": {
      "title": "Hermano Klaus y la Visión en Ranft",
    ...
    "pt": {
      "title": "Irmão Klaus e a Visão no Ranft",
    ...
    "ru": {
      "title": "Окаменевшие гиганты Мифена",
      "text": "Большой и Малый Мифен у Швица были, согласно легенде, двумя братьями-великанами, которые так ожесточённо спорили о владении альпийским пастбищем, что сами горы положили конец их ссоре и превратили их в камень. С тех пор оба пика стоят рядом на все времена как назидание — вечно разделённые и всё же вечно связанные.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "fr": {
      "title": "La Nixe aux Chutes du Rhin",
    ...
    "it": {
      "title": "La Ninfa alle Cascate del Reno",
    ...
    "en": {
      "title": "The Nixie at the Rhine Falls",
    ...
    "es": {
      "title": "La Ninfa en las Cataratas del Rin",
    ...
    "pt": {
      "title": "A Ninfa nas Cataratas do Reno",
    ...
    "ru": {
      "title": "Святой Урс, безголовый легионер",
      "text": "Урс, согласно древней легенде Фиванского легиона, около 300 года вместе со своими христианскими соратниками отказался приносить жертвы римским богам и был обезглавлен под Золотурном. По преданию, он затем встал и нёс свою собственную голову к месту, где хотел быть погребённым. И по сей день герб города Золотурна изображает его с головой в руках.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Di versteinertä Riisä vo de Mythen",
    ...
    "fr": {
      "title": "Les géants pétrifiés du Mythen",
    ...
    "it": {
      "title": "I giganti pietrificati del Mythen",
    ...
    "en": {
      "title": "The Petrified Giants of Mythen",
    ...
    "es": {
      "title": "Los gigantes petrificados del Mythen",
    ...
    "pt": {
      "title": "Os gigantes petrificados do Mythen",
    ...
    "ru": {
      "title": "Дьявол и мост Понте-дей-Салти",
      "text": "Жители Лавертеццо в долине Верзаски, согласно тичинской традиции, не могли переправиться через бурлящую Верзаску, пока дьявол не предложил построить им мост за первую душу, которая на него ступит. Как и в других местах Альп, жители долины перехитрили его, угнав животное через Понте-дей-Салти, и дьявол, ворча, вынужден был признать поражение.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Der heilig Ursus, der chopflos Legionär",
    ...
    "fr": {
      "title": "Saint Ursus, le légionnaire sans tête",
    ...
    "it": {
      "title": "Sant'Orso, il legionario senza testa",
    ...
    "en": {
      "title": "Saint Ursus, the Headless Legionary",
    ...
    "es": {
      "title": "San Ursus, el legionario sin cabeza",
    ...
    "pt": {
      "title": "Santo Urso, o legionário sem cabeça",
    ...
    "ru": {
      "title": "Легенда об Оттенберге",
      "text": "На Оттенберге у Вайнфельдена, где когда-то стояла крепость Альт-Вайнфельден, так рассказывают старые тургауские легенды, в полнолуния слышны звон доспехов и далёкое звучание охотничьего рога. Это остатки проклятого рыцарского рода, который за свою гордыню никогда не найдёт покоя и бродит по склонам холма.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Der Tüüfel und d Ponte dei Salti",
    ...
    "fr": {
      "title": "Le diable et le Ponte dei Salti",
    ...
    "it": {
      "title": "Il diavolo e il Ponte dei Salti",
    ...
    "en": {
      "title": "The Devil and the Ponte dei Salti",
    ...
    "es": {
      "title": "El diablo y el Ponte dei Salti",
    ...
    "pt": {
      "title": "O diabo e a Ponte dei Salti",
    ...
    "ru": {
      "title": "Святой Теодул и колокол",
      "text": "Святой Теодул, первый епископ Валлиса, хотел доставить в свою церковь в Сьоне колокол из Рима. Когда не нашлось носильщика, легенда рассказывает, что он просто привязал к колоколу самого дьявола и заставил его нести его через Альпы. В наказание за свою злобу дьявол должен был тащить тяжелый груз до самой Сьоны, где колокол звонит и по сей день.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    ...
    "it": {
      "title": "La leggenda di Ottenberg",
    ...
    "ru": {
      "title": "Затонувший пригород Цуга",
      "text": "В 1435 году часть берега под пригородом Цуга внезапно обрушилась и утащила дома и людей в воды озера Цуг. Согласно преданию, в ясные ночи можно услышать огни и звон затонувших колоколов глубоко под поверхностью воды — тихий памятник потерянному пригороду.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Der heilig Theodul und d Glogge",
    ...
    "fr": {
      "title": "Saint Théodul et la cloche",
    ...
    "it": {
      "title": "Santo Teodulo e la campana",
    ...
    "en": {
      "title": "Saint Theodul and the Bell",
    ...
    "es": {
      "title": "San Teodulo y la campana",
    ...
    "ru": {
      "title": "Феликс и Регула, безголовые святые покровители",
      "text": "Феликс и Регула, брат и сестра, воины Фиванского легиона, по легенде были обезглавлены около 300 года в Цюрихе за свою христианскую веру. Согласно преданию, после казни оба восстали, взяли собственные головы в руки и поднялись на холм, чтобы быть похороненными на месте, где сегодня стоит Гроссмюнстер.",
      "reviewEmpfohlen": true
    }
  },
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "D versunkä Vorstadt vo Zug",
    ...
    "fr": {
      "title": "Le faubourg englouti de Zoug",
    ...
    "it": {
      "title": "Il sobborgo sommerso di Zugo",
    ...
    "en": {
      "title": "The Sunken Suburb of Zug",
    ...
    "es": {
      "title": "El suburbio hundido de Zugo",
    ...
    "pt": {
      "title": "O subúrbio submerso de Zug",
...
},
{
  ...
  "summaries": {
    "gsw": {
      "title": "Felix und Regula, d chopflosen Stadtheiligä",
    ...
    "fr": {
      "title": "Félix et Régula, les saints urbains sans tête",
    ...
    "it": {
      "title": "Felice e Regola, i santi cittadini senza testa",
    ...
    "en": {
      "title": "Felix and Regula, the Headless City Saints",
    ...
    "pt": {
      "title": "Félix e Régula, os santos da cidade sem cabeça",
