 ...
 * Pack 1 deckt die neun aktuellen Sagen eines Kantons ab,
 * Pack 2 deckt Indizes SAGEN_PRO_PACK bis 2*SAGEN_PRO_PACK-1, usw.
 */
export const SAGEN_PRO_PACK = 9;

/**
 * DB-Pack-Slug fuer eine Sage basierend auf ihrem 0-basierten Index im Kanton.
 * Pack 1 (Index 0-8): kantonSlug
 * Pack 2 (Index 9-17): kantonSlug + "_2"
 * Pack 3 (Index 18-26): kantonSlug + "_3" usw.
 */
