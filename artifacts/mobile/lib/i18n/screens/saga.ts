...
const SAGA_STRINGS: StringsDict<SagaStrings> = {
  de: {
    ...
    lockedText: "Deine kostenlose Wanderung wurde bereits genutzt. Schalte Premium frei, um unbegrenzt zu wandern.",
  ...
  gsw: {
    ...
    lockedText: "Dini kostenlossi Wanderig isch scho gnutzt worde. Schalt Premium frei zum wiiter z'wandere.",
  ...
  en: {
    ...
    lockedText: "Your free hike has already been used. Unlock Premium for unlimited hikes.",
  ...
  fr: {
    ...
    lockedText: "Votre randonnée gratuite a déjà été utilisée. Déverrouillez Premium pour des randonnées illimitées.",
  ...
  it: {
    ...
    lockedText: "La tua escursione gratuita è già stata utilizzata. Sblocca Premium per escursioni illimitate.",
  ...
  es: {
    ...
    lockedText: "Tu caminata gratuita ya ha sido utilizada. Desbloquea Premium para caminatas ilimitadas.",
  ...
  pt: {
    ...
    lockedText: "A sua caminhada gratuita já foi utilizada. Desbloqueie o Premium para caminhadas ilimitadas.",
    premiumButton: "Desbloquear Premium",
  ...
  zh: {
    ...
    sourceLabel: "来源（公有领域）",
    lockedText: "您的免费徒步已使用。解锁 Premium 享受无限徒步旅行。",
  ...
  ru: {
    ...
    lockedText: "Твой бесплатный поход уже использован. Разблокируй Premium для неограниченных походов.",
