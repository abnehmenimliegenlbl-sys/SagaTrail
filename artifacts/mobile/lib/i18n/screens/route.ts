oteLabel: "Aammerkig (optional)",
    ...
    themeEvidenceUnavailableOffline:
      "Offline sind für die Route kei Themenbeleg gspeicheret.",
  },
  en: {
    ...
    themeEvidenceUnavailableOffline:
      "No theme evidence for this route is saved offline.",
  },
  fr: {
    ...
    themeEvidenceUnavailableOffline:
      "Aucune preuve thématique de cet itinéraire n’est enregistrée hors ligne.",
  },
  it: {
    ...
    themeEvidenceUnavailableOffline:
      "Nessuna prova tematica di questo itinerario è salvata offline.",
  },
  es: {
    ...
    themeEvidenceUnavailableOffline:
      "No hay evidencias temáticas de esta ruta guardadas sin conexión.",
  },
  pt: {
    ...
    themeEvidenceUnavailableOffline:
      "Não há provas temáticas desta rota guardadas offline.",
  },
  zh: {
    notFound: "未找到路线。",
    title: "路线规划",
  ...
  ru: {
    ...
    themeEvidenceUnavailableOffline:
      "В офлайн-пакете нет тематических подтверждений для этого маршрута.",
  },
};
