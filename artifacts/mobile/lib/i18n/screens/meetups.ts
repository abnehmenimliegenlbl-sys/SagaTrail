...
const STRINGS: StringsDict<MeetupStrings> = {
  ...
  gsw: {
    ...
    participantsTitle: "Teilnehmendi", organizerBadge: "Organisator", calendarDialogTitle: "Treffpunkt i Kaländer überneh",
  ...
  fr: {
    ...
    participantsTitle: "Participants", organizerBadge: "Organisateur", calendarDialogTitle: "Ajouter le rendez-vous au calendrier",
  ...
  it: {
    ...
    participantsTitle: "Partecipanti", organizerBadge: "Organizzatore", calendarDialogTitle: "Aggiungi il ritrovo al calendario",
  ...
  en: {
    ...
    participantsTitle: "Participants", organizerBadge: "Organizer", calendarDialogTitle: "Add meetup to calendar",
  ...
  zh: {
    ...
    participantsTitle: "参与者", organizerBadge: "组织者", calendarDialogTitle: "将集合添加到日历",
  ...
  es: {
    ...
    participantsTitle: "Participantes", organizerBadge: "Organizador", calendarDialogTitle: "Añadir encuentro al calendario",
  ...
  pt: {
    ...
    participantsTitle: "Participantes", organizerBadge: "Organizador", calendarDialogTitle: "Adicionar encontro ao calendário",
  ...
  ru: {
    ...
    participantsTitle: "Участники", organizerBadge: "Организатор", calendarDialogTitle: "Добавить встречу в календарь",
