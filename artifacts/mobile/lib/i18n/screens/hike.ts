...
export interface HikeStrings {
  ...
  offlineHikeDetail: string;
  compassStatusHint: string;
  arTrackingHint: string;
  arUnavailableHint: string;
...
const HIKE_STRINGS: StringsDict<HikeStrings> = {
  de: {
    ...
    gpsSignalLostHint: "Fortschritt, Wegführung und automatische Ansagen pausieren. Geh an einen Ort mit freier Sicht zum Himmel und prüfe den Standortzugriff.",
    allow: "Erlauben",
    gpsRetry: "GPS erneut prüfen",
    ...
    arTrackingPaused: "Die AR-Wegführung bleibt pausiert, bis das AR-Tracking stabil ist.",
    ...
    offlineHikeBanner: "Keine Internetverbindung",
    offlineHikeDetail: "Gespeicherte Kartendaten bleiben verfügbar. Live-Infos werden bei wiederhergestellter Verbindung erneut geladen.",
    compassStatusHint: "Bewege das Handy langsam in einer Acht. Die normale Karte funktioniert weiterhin.",
    arTrackingHint: "Halte das Gerät ruhig und richte die Kamera auf eine strukturierte Umgebung. Die normale Karte bleibt verfügbar.",
    arUnavailableHint: "AR ist auf diesem Gerät nicht verfügbar. Nutze die normale Karte für die Wegführung.",
  ...
  gsw: {
    ...
    gpsSignalLostHint: "Fortschritt, Wägfüehrig und automatischi Ansage pausiered. Gang an en Ort mit freier Sicht zum Himmel und prüef de Standortzuegriff.",
    allow: "Erlaube",
    gpsRetry: "GPS nomol prüefe",
    ...
    arTrackingPaused: "D AR-Wägfüehrig bliibt pausiert, bis s AR-Tracking stabil isch.",
    ...
    offlineHikeBanner: "Kei Internetverbindig",
    offlineHikeDetail: "Gspeichereti Kartedate bliibed verfügbar. Live-Infos werdet bi wiederhgestellter Verbindig neu glade.",
    compassStatusHint: "Beweg s Handy langsam i ere Achti. D normale Charte funktioniert wiiter.",
    arTrackingHint: "Heb s Gerät ruhig und richt d Kamera uf e strukturierte Umgebig. D normale Charte bliibt verfügbar.",
    arUnavailableHint: "AR isch uf dem Gerät nid verfügbar. Bruuch d normale Charte für d Wägfüehrig.",
  ...
  en: {
    ...
    gpsSignalLostHint: "Progress, route guidance and automatic announcements are paused. Move to a place with a clear view of the sky and check location access.",
    allow: "Allow",
    gpsRetry: "Retry GPS",
    ...
    arTrackingPaused: "AR route guidance stays paused until AR tracking is stable.",
    ...
    offlineHikeBanner: "No internet connection",
    offlineHikeDetail: "Saved map data remain available. Live information will load again when the connection returns.",
    compassStatusHint: "Move the phone slowly in a figure eight. The regular map still works.",
    arTrackingHint: "Hold the phone steady and point the camera at a detailed scene. The regular map remains available.",
    arUnavailableHint: "AR isn't available on this device. Use the regular map for guidance.",
  ...
  fr: {
    ...
    gpsSignalLostHint: "La progression, le guidage et les annonces automatiques sont en pause. Avancez vers un endroit dégagé et vérifiez l’accès à la localisation.",
    allow: "Autoriser",
    gpsRetry: "Réessayer le GPS",
    ...
    arTrackingPaused: "Le guidage AR reste en pause jusqu'à ce que le suivi AR soit stable.",
    ...
    offlineHikeBanner: "Pas de connexion Internet",
    offlineHikeDetail: "Les cartes enregistrées restent disponibles. Les infos en direct se rechargeront au retour de la connexion.",
    compassStatusHint: "Déplacez lentement le téléphone en dessinant un huit. La carte normale reste disponible.",
    arTrackingHint: "Tenez le téléphone immobile et dirigez la caméra vers un environnement détaillé. La carte normale reste disponible.",
    arUnavailableHint: "La réalité augmentée n’est pas disponible sur cet appareil. Utilisez la carte normale.",
  ...
  it: {
    ...
    gpsSignalLostHint: "Progressi, guida e annunci automatici sono in pausa. Spostati in un luogo aperto e controlla l’accesso alla posizione.",
    allow: "Consenti",
    gpsRetry: "Riprova GPS",
    ...
    arTrackingPaused: "La navigazione AR resta in pausa finché il tracciamento AR non è stabile.",
    ...
    offlineHikeBanner: "Nessuna connessione Internet",
    offlineHikeDetail: "Le mappe salvate restano disponibili. Le informazioni live si ricaricheranno al ritorno della connessione.",
    compassStatusHint: "Muovi lentamente il telefono disegnando un otto. La mappa normale continua a funzionare.",
    arTrackingHint: "Tieni fermo il telefono e punta la fotocamera verso un ambiente dettagliato. La mappa normale resta disponibile.",
    arUnavailableHint: "La realtà aumentata non è disponibile su questo dispositivo. Usa la mappa normale.",
  ...
  es: {
    ...
    gpsSignalLostHint: "El progreso, la guía y los avisos automáticos están pausados. Ve a un lugar despejado y comprueba el acceso a la ubicación.",
    allow: "Permitir",
    gpsRetry: "Reintentar GPS",
    ...
    arTrackingPaused: "La guía AR permanece pausada hasta que el seguimiento AR sea estable.",
    ...
    offlineHikeBanner: "Sin conexión a Internet",
    offlineHikeDetail: "Los mapas guardados siguen disponibles. La información en directo se cargará cuando vuelva la conexión.",
    compassStatusHint: "Mueve el teléfono lentamente dibujando un ocho. El mapa normal sigue funcionando.",
    arTrackingHint: "Mantén el teléfono quieto y apunta la cámara a un entorno con detalles. El mapa normal sigue disponible.",
    arUnavailableHint: "La realidad aumentada no está disponible en este dispositivo. Usa el mapa normal.",
  ...
  pt: {
    ...
    gpsSignalLostHint: "O progresso, a orientação e os avisos automáticos estão em pausa. Vai para um local aberto e verifica o acesso à localização.",
    allow: "Permitir",
    gpsRetry: "Tentar GPS novamente",
    ...
    arTrackingPaused: "A orientação AR permanece pausada até o seguimento AR estabilizar.",
    ...
    offlineHikeBanner: "Sem ligação à Internet",
    offlineHikeDetail: "Os mapas guardados continuam disponíveis. A informação em direto será carregada quando a ligação voltar.",
    compassStatusHint: "Move o telemóvel devagar, desenhando um oito. O mapa normal continua disponível.",
    arTrackingHint: "Mantém o telemóvel imóvel e aponta a câmara para um ambiente detalhado. O mapa normal continua disponível.",
    arUnavailableHint: "A realidade aumentada não está disponível neste dispositivo. Usa o mapa normal.",
  ...
  zh: {
    ...
    gpsSignalLostHint: "进度、路线指引和自动播报已暂停。请前往视野开阔处，并检查定位权限。",
    allow: "允许",
    gpsRetry: "重新检查 GPS",
    ...
    arTrackingPaused: "增强现实路线引导将在增强现实追踪稳定前保持暂停。",
    ...
    offlineHikeBanner: "无互联网连接",
    offlineHikeDetail: "已保存的地图仍可使用；网络恢复后会重新加载实时信息。",
    compassStatusHint: "将手机缓慢画“8”字移动。普通地图仍可使用。",
    arTrackingHint: "请握稳手机，并将摄像头对准有细节的环境。普通地图仍可使用。",
    arUnavailableHint: "此设备无法使用增强现实，请使用普通地图导航。",
  ...
  ru: {
    ...
    gpsSignalLostHint: "Прогресс, навигация и автоматические сообщения приостановлены. Перейдите на открытое место и проверьте доступ к геопозиции.",
    allow: "Разрешить",
    gpsRetry: "Проверить GPS снова",
    ...
    arTrackingPaused: "AR-навигация приостановлена, пока отслеживание AR не стабилизируется.",
    ...
    offlineHikeBanner: "Нет подключения к интернету",
    offlineHikeDetail: "Сохранённые карты останутся доступны. Текущая информация загрузится после восстановления соединения.",
    compassStatusHint: "Медленно поводите телефоном, рисуя восьмёрку. Обычная карта продолжит работать.",
    arTrackingHint: "Держите телефон неподвижно и направьте камеру на детализированную сцену. Обычная карта остаётся доступна.",
    arUnavailableHint: "Дополненная реальность недоступна на этом устройстве. Используйте обычную карту.",
