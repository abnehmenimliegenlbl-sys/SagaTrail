...
const GRUPPE_STRINGS: StringsDict<GruppeStrings> = {
  ...
  gsw: {
    ...
    locationFresh: "Standort aktuell",
    locationStale: "Standort veraltet",
    locationUnavailable: "Kei GPS-Standort teilt",
    locationSharingTitle: "Standort i de Gruppe teile",
    locationSharingBody: "Nume während ere aktive Wanderig und nume mit dinere Zustimmig.",
    rendezvousLabel: "Treffpunkt",
    setRendezvousButton: "Treffpunkt da setze",
  },
  fr: {
    ...
    locationFresh: "Position actuelle",
    locationStale: "Position obsolète",
    locationUnavailable: "Aucune position GPS partagée",
    locationSharingTitle: "Partager sa position avec le groupe",
    locationSharingBody: "Uniquement pendant une randonnée active et avec ton accord.",
    rendezvousLabel: "Point de rendez-vous",
    setRendezvousButton: "Définir le point de rendez-vous ici",
  },
  it: {
    ...
    locationFresh: "Posizione aggiornata",
    locationStale: "Posizione obsoleta",
    locationUnavailable: "Nessuna posizione GPS condivisa",
    locationSharingTitle: "Condividi la posizione nel gruppo",
    locationSharingBody: "Solo durante un'escursione attiva e con il tuo consenso.",
    rendezvousLabel: "Punto d'incontro",
    setRendezvousButton: "Imposta qui il punto d'incontro",
  },
  en: {
    ...
    locationFresh: "Location current",
    locationStale: "Location stale",
    locationUnavailable: "No GPS location shared",
    locationSharingTitle: "Share location with the group",
    locationSharingBody: "Only during an active hike and only with your consent.",
    rendezvousLabel: "Meeting point",
    setRendezvousButton: "Set meeting point here",
  },
  zh: {
    eyebrow: "共同徒步",
    title: "小组",
    ...
    locationFresh: "位置最新",
    locationStale: "位置已过期",
    locationUnavailable: "未分享 GPS 位置",
    locationSharingTitle: "在小组中分享位置",
    locationSharingBody: "仅在徒步进行期间，并且只有在你同意的情况下分享。",
    rendezvousLabel: "集合点",
    setRendezvousButton: "在此设置集合点",
  },
  es: {
    ...
    locationFresh: "Ubicación actualizada",
    locationStale: "Ubicación obsoleta",
    locationUnavailable: "No se ha compartido la ubicación GPS",
    locationSharingTitle: "Compartir ubicación con el grupo",
    locationSharingBody: "Solo durante una caminata activa y con tu consentimiento.",
    rendezvousLabel: "Punto de encuentro",
    setRendezvousButton: "Establecer aquí el punto de encuentro",
  },
  pt: {
    ...
    locationFresh: "Localização atual",
    locationStale: "Localização desatualizada",
    locationUnavailable: "Nenhuma localização GPS compartilhada",
    locationSharingTitle: "Compartilhar localização com o grupo",
    locationSharingBody: "Somente durante uma caminhada ativa e com o seu consentimento.",
    rendezvousLabel: "Ponto de encontro",
    setRendezvousButton: "Definir ponto de encontro aqui",
  },
  ru: {
    eyebrow: "Поход вместе",
    title: "Группа",
    ...
    joinSessionTitle: "Присоединиться к сессии",
    joinCodePlaceholder: "6-значный код",
    joinSessionButton: "Присоединиться",
    connecting: "Подключение …",
    statusLive: "Подключено в реальном времени",
    statusDisconnected: "Отключено",
    codeLabelLeader: "ТВОЙ КОД ПРИСОЕДИНЕНИЯ",
    codeLabelMember: "АКТИВНАЯ СЕССИЯ",
    tierNote: (tierName) => `Уровень повествования: ${tierName} (самый младший участник)`,
    membersTitle: (count) => `Участники (${count})`,
    leaderLabel: "Лидер",
    activityWandering: (sagaTitle) => `в походе: ${sagaTitle}`,
    joinHikeButton: "Присоединиться к походу",
    activityReady: "готов",
    ...
    locationFresh: "Местоположение актуально",
    locationStale: "Местоположение устарело",
    locationUnavailable: "Местоположение GPS не передаётся",
    locationSharingTitle: "Делиться местоположением с группой",
    locationSharingBody: "Только во время активного похода и с твоего согласия.",
    rendezvousLabel: "Место встречи",
    setRendezvousButton: "Установить место встречи здесь",
  },
};
