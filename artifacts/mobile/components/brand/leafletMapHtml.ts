...
<head>
  ...
  <style>
    ...
    button { border: 0; padding: 7px 10px; border-radius: 8px; background: rgba(16,24,26,.9); color: #8A9BA8; font: 600 12px -apple-system,system-ui,sans-serif; }
...
<body>
  ...
  (function () {
    ...
    (pois || []).forEach(function (p) { addMarker(p, L.divIcon({ className: "", html: '<div class="poi-tipp"><div class="poi"></div></div>', iconSize: [36,36], iconAnchor: [18,33] }), "stt-poi-press"); });
    var partnerIcons = {
