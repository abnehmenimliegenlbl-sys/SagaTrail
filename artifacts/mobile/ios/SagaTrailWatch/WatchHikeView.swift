...
struct WatchCopy {
  ...
  private static let commonWords: [String: [String: String]] = [
    ...
    "zh": [
      "navigation": "导航", "current": "当前", "status": "状态", "poiStory": "地点故事",
      "turnCrown": "旋转表冠",
      "noGps": "没有 GPS 信号", "noGpsShort": "无 GPS", "gpsLiveShort": "GPS 实时", "noGpsDetail": "导航正在等待新的信号",
      "gpsAvailable": "GPS 可用", "turnLeft": "左转", "turnRight": "右转",
      "turnAround": "掉头", "goStraight": "直行",
      "safeNow": "我很安全", "summaryPhone": "在 iPhone 上查看详情",
      "gpsPaused": "没有 GPS 信号",
    ],
    "ru": [
      "navigation": "Навигация", "current": "Сейчас", "status": "Статус", "poiStory": "История места",
      "turnCrown": "Поверните колесико",
      "noGps": "Нет сигнала GPS", "noGpsShort": "Нет GPS", "gpsLiveShort": "GPS в сети", "noGpsDetail": "Навигация ждёт новый сигнал",
      "gpsAvailable": "GPS доступен", "turnLeft": "НАЛЕВО", "turnRight": "НАПРАВО",
      "turnAround": "РАЗВОРОТ", "goStraight": "ПРЯМО",
      "safeNow": "Я в безопасности", "summaryPhone": "Подробности на iPhone",
      "gpsPaused": "Нет сигнала GPS",
    ],
    "nl": [
  ...
  private static let localizedAdditions: [String: [String: String]] = [
    ...
    "zh": [
      "sosTitle": "向 iPhone 发送 SOS？", "confirmSOS": "确认 SOS", "cancel": "取消",
      "sosMessage": "你的 iPhone 将启动紧急流程。",
      "safetyTitle": "安全签到", "safetyMessage": "iPhone 将启动现有的安全链接。",
      "safetyCompleteOnPhone": "请在 iPhone 上完成实时链接的发送。",
      "overdue": "签到已超时", "safetyActive": "签到进行中", "liveLink": "实时链接已启用",
      "localTimer": "仅本地计时器", "stopTimer": "安全 — 停止计时", "startCheckin": "开始签到",
      "startMarker": "起点", "finishMarker": "终点", "offlineRoute": "离线路线",
      "lastRoute": "上一条路线", "north": "北", "route": "路线",
      "minutes": "分钟", "storyAudio": "故事 / 音频", "mapYou": "你",
      "weatherClear": "晴朗", "weatherCloudy": "多云", "weatherFog": "雾", "weatherRain": "雨",
      "weatherSnow": "雪", "weatherStorm": "雷雨", "weather": "天气",
      "healthNotStarted": "心率尚未开始", "healthUnavailable": "HealthKit 不可用",
      "healthTypesUnavailable": "HealthKit 数据类型不可用", "healthAccessRequired": "需要 HealthKit 权限",
      "workoutReady": "训练已准备好", "liveHeartRate": "实时心率", "heartRateStartFailed": "无法开始测量心率",
      "workoutSaved": "训练已保存", "workoutSaveFailed": "无法保存训练", "workoutFailed": "训练已中断",
      "complicationNoGPS": "无 GPS", "complicationOffRoute": "偏离路线", "complicationPause": "暂停",
      "complicationWait": "等待", "complicationBack": "返回", "complicationWaitSignal": "等待信号",
    ],
    "ru": [
      "sosTitle": "Отправить SOS на iPhone?", "confirmSOS": "Подтвердить SOS", "cancel": "Отмена",
      "sosMessage": "iPhone запустит экстренную процедуру.",
      "safetyTitle": "Проверка безопасности", "safetyMessage": "iPhone запустит существующую ссылку безопасности.",
      "safetyCompleteOnPhone": "Завершите отправку ссылки в реальном времени на iPhone.",
      "overdue": "Проверка просрочена", "safetyActive": "Проверка активна", "liveLink": "Ссылка активна",
      "localTimer": "Только локальный таймер", "stopTimer": "В безопасности — остановить", "startCheckin": "Начать проверку",
      "startMarker": "Старт", "finishMarker": "Финиш", "offlineRoute": "Офлайн-маршрут",
      "lastRoute": "Последний маршрут", "north": "Север", "route": "Маршрут",
      "minutes": "минут", "storyAudio": "История / аудио", "mapYou": "Вы",
      "weatherClear": "Ясно", "weatherCloudy": "Облачно", "weatherFog": "Туман", "weatherRain": "Дождь",
      "weatherSnow": "Снег", "weatherStorm": "Гроза", "weather": "Погода",
      "healthNotStarted": "Пульс не запущен", "healthUnavailable": "HealthKit недоступен",
      "healthTypesUnavailable": "Типы данных HealthKit недоступны", "healthAccessRequired": "Требуется доступ к HealthKit",
      "workoutReady": "Тренировка готова", "liveHeartRate": "Пульс в реальном времени", "heartRateStartFailed": "Не удалось запустить пульс",
      "workoutSaved": "Тренировка сохранена", "workoutSaveFailed": "Не удалось сохранить тренировку", "workoutFailed": "Тренировка прервана",
      "complicationNoGPS": "НЕТ GPS", "complicationOffRoute": "ВНЕ МАРШРУТА", "complicationPause": "Пауза",
      "complicationWait": "Ожидание", "complicationBack": "Назад", "complicationWaitSignal": "Ожидание сигнала",
    ],
    "nl": [
  ...
  private static let words: [String: [String: String]] = [
    ...
    "zh": [
      "live": "来自 iPhone 的实时数据", "unreachable": "无法连接 iPhone", "stale": "数据已过期",
      "now": "现在", "ago": "前", "waiting": "正在等待 iPhone",
      "waitingStart": "等待徒步开始", "waitingPhone": "等待你的 iPhone",
      "waitingNext": "等待你的下一次定位", "pausedStatus": "已暂停 — 准备好后继续",
      "finishedStatus": "徒步已完成", "next": "接着", "ascent": "上坡", "descent": "下坡",
      "startsIn": "开始于", "still": "剩余", "time": "时间", "distance": "距离", "remaining": "剩余", "arrival": "到达",
      "elevation": "爬升", "remainingAscent": "剩余爬升", "steps": "步数",
      "start": "开始", "pause": "暂停", "resume": "继续", "sos": "SOS",
      "offRoute": "偏离路线", "atLeast": "至少", "fromRoute": "距计划路线",
      "returnDirection": "返回方向", "returnToRoute": "请走回标记的路线。",
      "sunset": "日落", "afterSunset": "预计将在日落后到达", "gusts": "强阵风最高达", "thunderstorm": "雷暴风险", "completed": "徒步已完成",
      "totalTime": "总时间", "totalDistance": "总距离", "lastHeartRate": "最近心率", "pulse": "心率",
      "averageHeartRate": "平均心率", "maxHeartRate": "最高心率", "activeEnergy": "活动能量",
      "sosTitle": "向 iPhone 发送 SOS？", "confirmSOS": "确认 SOS", "cancel": "取消",
      "sosMessage": "你的 iPhone 将启动紧急流程。", "safetyTitle": "安全签到", "safetyMessage": "iPhone 将启动现有的安全链接。",
      "safetyCompleteOnPhone": "请在 iPhone 上完成实时链接的发送。", "overdue": "签到已超时", "safetyActive": "签到进行中", "liveLink": "实时链接已启用",
      "localTimer": "仅本地计时器", "stopTimer": "安全 — 停止计时", "startCheckin": "开始签到",
      "startMarker": "起点", "finishMarker": "终点", "offlineRoute": "离线路线", "gpsPaused": "没有 GPS 信号", "lastRoute": "上一条路线", "north": "北", "route": "路线",
      "surfaceAhead": "道路", "surfaceAsphalt": "沥青", "surfaceGravel": "碎石", "surfaceRock": "岩石", "surfaceWood": "木板", "surfaceNatural": "自然步道", "attractionAhead": "景点",
    ],
    "ru": [
      "live": "Прямой эфир с iPhone", "unreachable": "iPhone недоступен", "stale": "Данные устарели",
      "now": "сейчас", "ago": "назад", "waiting": "Ожидание iPhone",
      "waitingStart": "Ожидание начала похода", "waitingPhone": "Ожидание iPhone",
      "waitingNext": "Ожидание следующей геопозиции", "pausedStatus": "Пауза — продолжите, когда будете готовы",
      "finishedStatus": "Поход завершён", "next": "Далее", "ascent": "Подъём", "descent": "Спуск",
      "startsIn": "Начало через", "still": "Осталось", "time": "Время", "distance": "Расстояние", "remaining": "Осталось", "arrival": "Прибытие",
      "elevation": "Набор высоты", "remainingAscent": "Осталось набрать", "steps": "Шаги",
      "start": "Старт", "pause": "Пауза", "resume": "Продолжить", "sos": "SOS",
      "offRoute": "Вне маршрута", "atLeast": "Не менее", "fromRoute": "от запланированного маршрута",
      "returnDirection": "Назад к", "returnToRoute": "Вернитесь к отмеченному маршруту.",
      "sunset": "Закат", "afterSunset": "Расчётное прибытие после заката", "gusts": "Сильные порывы до", "thunderstorm": "Риск грозы", "completed": "Поход завершён",
      "totalTime": "Общее время", "totalDistance": "Общее расстояние", "lastHeartRate": "Последний пульс", "pulse": "Пульс",
      "averageHeartRate": "Средний пульс", "maxHeartRate": "Макс. пульс", "activeEnergy": "Активная энергия",
      "sosTitle": "Отправить SOS на iPhone?", "confirmSOS": "Подтвердить SOS", "cancel": "Отмена",
      "sosMessage": "iPhone запустит экстренную процедуру.", "safetyTitle": "Проверка безопасности", "safetyMessage": "iPhone запустит существующую ссылку безопасности.",
      "safetyCompleteOnPhone": "Завершите отправку ссылки в реальном времени на iPhone.", "overdue": "Проверка просрочена", "safetyActive": "Проверка активна", "liveLink": "Ссылка активна",
      "localTimer": "Только локальный таймер", "stopTimer": "В безопасности — остановить", "startCheckin": "Начать проверку",
      "startMarker": "Старт", "finishMarker": "Финиш", "offlineRoute": "Офлайн-маршрут", "gpsPaused": "Нет сигнала GPS", "lastRoute": "Последний маршрут", "north": "Север", "route": "Маршрут",
      "surfaceAhead": "Дорога", "surfaceAsphalt": "Асфальт", "surfaceGravel": "Гравий", "surfaceRock": "Скала", "surfaceWood": "Дерево", "surfaceNatural": "Природная тропа", "attractionAhead": "Достопримечательность",
    ],
    "nl": [
