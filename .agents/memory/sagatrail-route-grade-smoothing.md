...
**How to apply:** Keep the map-color calculation aligned with the terrain-analysis window in the mobile app and the duplicated WordPress route-map implementation.