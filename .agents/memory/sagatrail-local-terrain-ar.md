...
**Why:** The first visible mesh technically rendered but looked like an unexplained red slab in the camera view, so the terrain source and scale were not understandable.