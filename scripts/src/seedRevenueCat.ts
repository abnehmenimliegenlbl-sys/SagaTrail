...
const PROJECT_NAME = "SagaTrail";

const PRODUCT_IDENTIFIER = "sagatrail_premium_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "sagatrail_premium_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "SagaTrail Premium (Monthly)";
const PRODUCT_USER_FACING_TITLE = "SagaTrail Premium";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "SagaTrail iOS";
const APP_STORE_BUNDLE_ID = "com.sagatrail.app";
const PLAY_STORE_APP_NAME = "SagaTrail Android";
const PLAY_STORE_PACKAGE_NAME = "com.sagatrail.app";
...
// Priced to comfortably cover ElevenLabs narration cost (~$0.30-0.70/hike)
// even for frequent hikers, while staying in line with comparable
// outdoor/travel-companion app subscriptions.
const PRODUCT_PRICES = [
  { amount_micros: 6990000, currency: "USD" }, // $6.99
  { amount_micros: 6990000, currency: "EUR" }, // €6.99
  { amount_micros: 6990000, currency: "CHF" }, // CHF 6.99
];
